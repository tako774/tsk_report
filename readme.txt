東方心綺楼体験版 対戦結果報告ツール v0.01
http://tenco.info/
2013/5/12

！注意
本ツールは心綺楼体験版でしか利用できません。
また、本ツールで報告した対戦結果は、製品版とは別のゲームの
対戦結果として記録されますので、ご承知おきください。


○概要
このソフトウェアは、Tenco! サーバーに東方心綺楼体験版 対戦記録自動集計プログラムの対戦結果データを
報告するコマンドラインアプリケーションです。
Tenco! の詳細は、上記URLからご覧ください。


○東方心綺楼体験版 対戦記録自動集計プログラム について

さくらゆきかぜさん（@s_yukikaze）作成の対戦結果記録ツールです。
非想天則でいう東方心綺楼体験版 対戦記録自動集計プログラムにあたるツールになります。
こちらの対戦結果を報告するので、先にこちらを導入お願い致します。
入手先は、@s_yukikaze さんのツイートを掘り返してください。
...
東方心綺楼体験版 対戦記録自動集計プログラムのフォルダ内においてください（正確には、東方心綺楼体験版 対戦記録自動集計プログラムDBファイルの
置いてあるフォルダ内です）。
フォルダ名は自由に変えていただいてかまいません。

※特定の東方心綺楼体験版 対戦記録自動集計プログラムプロファイルデータのみを報告したい場合、
「設定ファイルについて」を参照し、データベースファイルのパスを書き換えてください
...
また、リプレイファイルの報告をするかどうかについても、
適宜入力してください。

その後、自動的に対戦結果報告を実施します。
デフォルトでは、全東方心綺楼体験版 対戦記録自動集計プログラムプロファイルのデータを送信します。
...
一番下の database: -> file_path: の部分で、東方心綺楼体験版 対戦記録自動集計プログラムのデータベースのパスを指定できます。
...
database: 
  file_path: ../*.db   # 東方心綺楼体験版 対戦記録自動集計プログラムのデータベースファイルパス
----
データベースファイルパスは、固定名・ワイルドカードを使った指定のどちらでもかまいません。
固定名とすると、１つの東方心綺楼体験版 対戦記録自動集計プログラムプロファイルのみを報告することができます。
...
○謝辞
プレイヤーの皆様
東方心綺楼体験版 対戦記録自動集計プログラムを制作したさくらゆきかぜさん（@s_yukikaze）
Tenco!ユーザーの皆様
黄昏フロンティアの皆様
